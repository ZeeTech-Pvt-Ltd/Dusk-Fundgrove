...
export default function SignIn() {
  useMeta({
    title: 'Sign In - Dusk Fundgrove Client Area',
    description: 'Sign in to your Dusk Fundgrove account to access your trading dashboard.',
    ...
    <section className="auth-wrap">
      <div className="container">
        <div className="form-card auth-card" data-reveal>
          ...
          <p>Sign in to your Dusk Fundgrove account.</p>
          ...
          <p className="auth-card__footer">
            New to Dusk Fundgrove? <Link to="/sign-up">Create an account</Link>
          </p>
        </div>
      </div>
    </section>
